...
router.put("/",(req,res)=>{
    ...
    const newUsers= users.filter((e)=>{
     ...
     if(isHave){
        ...
        const dataToWrite = `export const users =${JSON.stringify(newUsers, null, 4)};`;
        fs.writeFileSync("./src/mockdata/fakeUsers.js",dataToWrite);
     }
     else{
...
router.post("/",(req,res)=>{
  ...
  if(req.body.username&&req.body.password){
    ...
    const dataToWrite = `export const users =${JSON.stringify(users, null, 4)};`;
    fs.writeFileSync("./src/mockdata/fakeUsers.js",dataToWrite);
